...
library(unet)
labelInput ="F:\\PRB\\TRAIN\\PRB_2021_MASK_OPTIM\\Image"
MskDir="F:\\PRB\\TRAIN\\PRB_2021_MASK_OPTIM\\Mask"
Species="NFSPup"
batch_size = 15
...
##################
#pth=  "C:\\Users\\usato\\SSL_DB\\TRAIN\\TRAIN_20240405_points041\\Train_1_2_3\\Checkpoints\\Train_1_2_3_20240524_val_0.34_epoch_03_512.h5"
...
##############################################################################
if(exists("unet1")==F) {
 source("Modules/04.1_Unet512Create.r")
} 
##############################################################################  
