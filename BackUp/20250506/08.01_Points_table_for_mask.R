   ...
   # ObserverPointDIR=paste0(labelInput,"\\Polygons\\All_layers")
	...
	pthHouloutImg1=paste0(labelInput,"\\Predict\\PRESENCE")
	
	listImgHoul1=list.files(pthHouloutImg1)
	listImgHoul=list.files(pthHouloutImg)
	listImgHoul=c(listImgHoul1,listImgHoul)
