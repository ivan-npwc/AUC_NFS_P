	...
	Path_model = "C:\\Users\\usato\\SSL_DB\\System data\\Model\\NFSpup_FP_remove_20241206_loss_0.08_epoch_10.h5"
...
lstImgsAbs=list.files(AbsenceDir, full.names=T)
if(length(lstImgsAbs) !=0 ) {file.copy(lstImgsAbs,pth); unlink(AbsenceDir); dir.create(AbsenceDir, showWarnings=F)}
################################################################
