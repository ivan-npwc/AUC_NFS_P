#https://stackoverflow.com/questions/73325202/create-circular-areas-around-a-coordinate
    ...
    labelInput #="F:\\PRB\\PRYB_2022\\2022_2001_OPP\\20220803_175032\\20220803_175032_01"
...
MdlPol <-st_read(ModelPoligonPTH)
  ...
  # Создание полигона вокруг точек  учёта
    OBSER_POL <- st_buffer(x = OBS_CORD, dist=0.16)
    AU_POL <- st_buffer(x = PRED_CORD, dist=0.16)
	#################################################################################
