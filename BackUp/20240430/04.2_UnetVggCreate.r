...
unet1 <- function(shape, nlevels = 4, nfilters = 16, dropouts = dropouts){
...
unet1 <<- unet1(shape = c(512, 512, 3), nlevels = 4, nfilters = 64, dropouts = c(0.7, 0.7, 0.7, 0.7,0.7)) # for VGG16  # DROPOUT 1- NO DROPOUT. START SINCE 08
if (UseVGG16 ==T){
##############################################################################
