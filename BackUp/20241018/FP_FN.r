...
Species <- "NFSPup"
PatternPreds="#Train_1_2_3_20240529_val_0.61_epoch_01_512#.*kml|kml.*#Train_1_2_3_20240529_val_0.61_epoch_01_512#"
...
# Входные данные
	...
	ModelPoligonDir=paste0(labelInput,"\\Polygons\\Predict");ModelPoligonPTH=list.files(ModelPoligonDir, full.names=T, ,pattern="shp|kml")[1]
    ...
    ObserverPointP=list.files(paste0(labelInput,"\\Observer_count"), full.names=T, pattern="kml|shp")[1]
				...
				predPth = list.files(predDir, full.names=T, pattern=PatternPreds)
